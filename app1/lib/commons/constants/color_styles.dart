...
abstract class ColorStyles {
  ...
  /// Primary - 주요 색상 (Blue50)
  static const Color primary = blue50;
  
  /// Primary Light - 주요 색상 밝은 버전 (Blue20)
  static const Color primaryLight = blue20;
  
  /// Primary Dark - 주요 색상 어두운 버전 (Blue70)
  static const Color primaryDark = blue70;
  
  /// Secondary - 보조 색상 (CoolGray50)
  static const Color secondary = coolGray50;
  
  /// Success - 성공 색상 (Green30)
  static const Color success = green30;
  
  /// Error - 에러 색상 (Red30)
  static const Color error = red30;
  
  /// Warning - 경고 색상 (Yellow30)
  static const Color warning = yellow30;
  
  /// Info - 정보 색상 (Blue40)
  static const Color info = blue40;

  // ============================================================================
  // 배경 색상
  // ============================================================================
  
  /// Background - 기본 배경 색상 (White)
  static const Color background = white;
  
  /// Background Secondary - 보조 배경 색상 (Gray05)
  static const Color backgroundSecondary = gray05;
  
  /// Background Tertiary - 3차 배경 색상 (Gray10)
  static const Color backgroundTertiary = gray10;
  
  /// Surface - 표면 색상 (White)
  static const Color surface = white;
  
  /// Surface Variant - 표면 변형 색상 (Gray05)
  static const Color surfaceVariant = gray05;

  // ============================================================================
  // 텍스트 색상
  // ============================================================================
  
  /// Text Primary - 주요 텍스트 색상 (Black)
  static const Color textPrimary = black;
  
  /// Text Secondary - 보조 텍스트 색상 (Gray70)
  static const Color textSecondary = gray70;
  
  /// Text Tertiary - 3차 텍스트 색상 (Gray50)
  static const Color textTertiary = gray50;
  
  /// Text Disabled - 비활성화된 텍스트 색상 (Gray40)
  static const Color textDisabled = gray40;
  
  /// Text On Primary - 주요 색상 위의 텍스트 (White)
  static const Color textOnPrimary = white;
  
  /// Text On Secondary - 보조 색상 위의 텍스트 (White)
  ...
  /// Border - 기본 테두리 색상 (Gray20)
  static const Color border = gray20;
  
  /// Border Light - 밝은 테두리 색상 (Gray10)
  static const Color borderLight = gray10;
  
  /// Border Dark - 어두운 테두리 색상 (Gray30)
  static const Color borderDark = gray30;
  
  /// Divider - 구분선 색상 (Gray10)
  static const Color divider = gray10;

  // ============================================================================
  // 다크모드 색상 (다크 테마용)
  // ============================================================================
  
  /// Dark Background - 다크모드 배경 색상 (Gray90)
  static const Color darkBackground = gray90;
  
  /// Dark Surface - 다크모드 표면 색상 (Gray80)
  static const Color darkSurface = gray80;
  
  /// Dark Text Primary - 다크모드 주요 텍스트 색상 (White)
  static const Color darkTextPrimary = white;
  
  /// Dark Text Secondary - 다크모드 보조 텍스트 색상 (Gray30)
  static const Color darkTextSecondary = gray30;
  
  /// Dark Border - 다크모드 테두리 색상 (Gray70)
  static const Color darkBorder = gray70;
